...
function setArrows() {	
   ...
   alert($(".magazine").offset().left+"\n"+$('.next-button').offset().left);
	...
	var nextLeft= (width-bookWidth-magaLeft+80)/2;
	//alert("width "+width +"\nbookWidth :"+bookWidth +"\nmagaLeft:"+magaLeft+"\nnextLeft:"+nextLeft);
	$('.next-button').animate({ "right":nextLeft},100);
...
function loadLargePage(page, pageElement) {
    ...
    img.load(function() {
        ...
        var prevImg = pageElement.find('div');
        $(this).css({
            width: '100%',
            height: '100%'
        });
   ...
   //var h4 = $('<h4 />');
   //h4.attr('font-size', '30px');
}

// Load small page
function loadSmallPage(page, pageElement) {

    var img = pageElement.find('div');
